...
namespace Etdb.ServiceBase.DocumentRepository.Abstractions.Generics
{
    public interface IReadDocumentRepository<TDocument, in TId> where TDocument : class, IDocument<TId> where TId : IEquatable<TId>
    {
        ...
        IEnumerable<TDocument> FindAll(Expression<Func<TDocument, bool>> predicate, string collectionName = null, string partitionKey = null);
        ...
        TDocument Find(Expression<Func<TDocument, bool>> predicate, string collectionName = null, string partitionKey = null);
    }
}